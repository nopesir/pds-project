...
void jsonUtility::to_json_format_range(json &j, const std::string &op, const std::vector<std::pair<int,int>> &symbolsId, const int &format) {
    j = json{
            {"operation", op},
            {"symbolsId", symbolsId},
            {"format", format}
...
void jsonUtility::to_json_fontsize_change(json &j, const std::string &op, const std::vector<std::pair<int,int>> &symbolsId, const int &fontSize) {
    j = json{
            {"operation", op},
            {"symbolsId", symbolsId},
            {"fontSize", fontSize}
...
void jsonUtility::to_json_fontfamily_change(json &j, const std::string &op, const std::vector<std::pair<int,int>> &symbolsId, const std::string &fontFamily) {
    j = json{
            {"operation", op},
            {"symbolsId", symbolsId},
...
void jsonUtility::to_json_alignment_change(json &j, const std::string &op, const std::vector<std::pair<int,int>> &symbolsId, const int &alignment) {
    j = json{
            {"operation", op},
            {"symbolsId", symbolsId},
            {"alignment", alignment}
...
void jsonUtility::from_json_removal_range(const json &j, std::vector<std::pair<int,int>>& symbolsId) {
    symbolsId = j.at("symbolsId").get<std::vector<std::pair<int,int>>>();
}

void jsonUtility::from_json_format_range(const json &j, std::vector<std::pair<int,int>>& symbolsId, int& format) {
    symbolsId = j.at("symbolsId").get<std::vector<std::pair<int,int>>>();
    format = j.at("format").get<int>();
}

void jsonUtility::from_json_fontsize_change(const json &j, std::vector<std::pair<int,int>>& symbolsId, int& fontSize) {
    symbolsId = j.at("symbolsId").get<std::vector<std::pair<int,int>>>();
    fontSize = j.at("fontSize").get<int>();
}

void jsonUtility::from_json_fontfamily_change(const json &j, std::vector<std::pair<int,int>>& symbolsId, std::string& fontFamily) {
    symbolsId = j.at("symbolsId").get<std::vector<std::pair<int,int>>>();
    fontFamily = j.at("fontFamily").get<std::string>();
}

void jsonUtility::from_json_alignment_change(const json &j, std::vector<std::pair<int,int>>& symbolsId, int& alignment) {
    symbolsId = j.at("symbolsId").get<std::vector<std::pair<int,int>>>();
