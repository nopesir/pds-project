...
bool EditorWindow::eventFilter(QObject *obj, QEvent *ev) {
    ...
    if (obj == ui->RealTextEdit) {
        ...
        //******************************************** ALL THE OTHER CTRL COMBINATION ****************************
            ...
            //Serialize data
            json j;
            Jsonize::to_json_insertion(j, "INSERTION_REQUEST", tuple, getCurCharStyle());
            const std::string req = j.dump();
...
void EditorWindow::sendFormatRequest(int format) {
    ...
    if(cursor.hasSelection()) {
        ...
        //Serialize data
        json j;
        Jsonize::to_json_format_range(j, "FORMAT_RANGE_REQUEST", startIndex, endIndex, format);
        const std::string req = j.dump();
...
void EditorWindow::sendFontChangeRequest(int fontSize) {
    ...
    if(cursor.hasSelection()) {
        ...
        //Serialize data
        json j;
        Jsonize::to_json_fontsize_change(j, "FONTSIZE_CHANGE_REQUEST", startIndex, endIndex, fontSize);
        const std::string req = j.dump();
...
void EditorWindow::sendAlignChangeRequest(int blockStart, int blockEnd, int alignment) {
    ...
    //if(blockStart < blockEnd) {
        //Serialize data
        json j;
        Jsonize::to_json_alignment_change(j, "ALIGNMENT_CHANGE_REQUEST", blockStart, blockEnd, alignment);
        const std::string req = j.dump();
